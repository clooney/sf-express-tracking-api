SF Express Tracking API - .Net
================================
Use .Net to track SF Express shipments with SF Express Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.courierCode = "sf-express";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  getTrackingResultsParams.courierCode = "sf-express";
