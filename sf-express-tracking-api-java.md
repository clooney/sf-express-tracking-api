SF Express Tracking API - Java
================================
Use Java to track SF Express shipments with SF Express Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.sfexpress;
    ...
    public class CreateSfExpressTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("sf-express");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateSfExpressTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetSfExpressTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("sf-express");
...
Update a tracking by ID:
    ...
    public class UpdateSfExpressTrackingExample {
