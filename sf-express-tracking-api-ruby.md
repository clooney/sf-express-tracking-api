...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "LK201223662AU","courier_code"=>"sf-express"},{"tracking_number" => "LH290032509AU","courier_code"=>"sf-express"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"courier_code"=>"sf-express"}
      # params  = {"tracking_numbers" => "LK201223662AU,LH290032509AU","courier_code"=>"sf-express"}
